...
public class ThamDoChucNangService {
    ...
    public void createOrUpdateFromHIS(@Nonnull HoSoBenhAn hsba, @Nonnull List<ThamDoChucNang> tdcnList, String jsonSt) {
        ...
        logService.logAction(HoSoBenhAn.class.getName() + ".ThamDoChucNangList", hsba.id, MA_HANH_DONG.CHINH_SUA, new Date(), 
                                null, "", jsonSt);
    }
