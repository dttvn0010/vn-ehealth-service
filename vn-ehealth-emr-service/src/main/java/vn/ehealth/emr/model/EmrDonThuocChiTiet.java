...
@Document(collection = "emr_don_thuoc_chi_tiet")
public class EmrDonThuocChiTiet {

    @Id public ObjectId id;    
    public ObjectId emrDonThuocId;    
    ...
    public String getEmrDonThuocId() {
        return ObjectIdUtil.idToString(emrDonThuocId);
    }

    public void setEmrDonThuocId(String emrDonThuocId) {
        this.emrDonThuocId = ObjectIdUtil.stringToId(emrDonThuocId);
    }
