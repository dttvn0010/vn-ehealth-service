...
import vn.ehealth.hl7.fhir.base.entity.BundleEntity;
...
//		var includeMap = getIncludeMap(ResourceType.Bundle, keys, includes);
		...
		List<BundleEntity> entitys = mongo.find(query, BundleEntity.class);
	...
	public long countMatchesAdvancedTotal(
		...
		total = mongo.count(query, BundleEntity.class);
		return total;
	}
