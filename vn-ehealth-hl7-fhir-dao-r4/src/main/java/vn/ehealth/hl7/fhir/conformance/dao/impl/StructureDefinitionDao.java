package vn.ehealth.hl7.fhir.conformance.dao.impl;
...
import vn.ehealth.hl7.fhir.conformance.entity.StructureDefinitionEntity;
import vn.ehealth.hl7.fhir.core.entity.BaseResource;
import vn.ehealth.hl7.fhir.core.util.ConstantKeys;
import vn.ehealth.hl7.fhir.dao.BaseDao;
import vn.ehealth.hl7.fhir.definitionalartifact.entity.ActivityDefinitionEntity;

@Repository
public class StructureDefinitionDao extends BaseDao<StructureDefinitionEntity, StructureDefinition> {

	@Override
	protected Class<? extends BaseResource> getEntityClass() {
		return StructureDefinitionEntity.class;
	}
...
//		var includeMap = getIncludeMap(ResourceType.Bundle, keys, includes);
		...
		List<StructureDefinitionEntity> entitys = mongo.find(query, StructureDefinitionEntity.class);
		if (entitys != null && entitys.size() > 0) {
			for (StructureDefinitionEntity item : entitys) {
				StructureDefinition obj = transform(item);
