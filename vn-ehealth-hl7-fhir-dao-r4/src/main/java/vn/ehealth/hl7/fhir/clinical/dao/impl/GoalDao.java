...
public class GoalDao extends BaseDao<GoalEntity, Goal> {
	...
	public long countMatchesAdvancedTotal(FhirContext fhirContext, TokenParam category, TokenParam identifier,
			ReferenceParam patient, DateRangeParam startDate, TokenParam status, ReferenceParam subject,
	...
	private Criteria setParamToCriteria(TokenParam category, TokenParam identifier, ReferenceParam patient,
			DateRangeParam startDate, TokenParam status, ReferenceParam subject, DateRangeParam targetDate,
			TokenParam resid, DateRangeParam _lastUpdated, TokenParam _tag, UriParam _profile, TokenParam _query,
