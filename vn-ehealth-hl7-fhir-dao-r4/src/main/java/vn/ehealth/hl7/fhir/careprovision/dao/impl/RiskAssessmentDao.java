package vn.ehealth.hl7.fhir.careprovision.dao.impl;
...
import vn.ehealth.hl7.fhir.careprovision.entity.RiskAssessmentEntity;
import vn.ehealth.hl7.fhir.core.entity.BaseResource;
import vn.ehealth.hl7.fhir.core.util.ConstantKeys;
import vn.ehealth.hl7.fhir.dao.BaseDao;

@Repository
public class RiskAssessmentDao extends BaseDao<RiskAssessmentEntity, RiskAssessment> {

	@Override
	protected String getProfile() {
		return "RiskAssessment-v1.0";
	}

	@Override
	protected Class<? extends BaseResource> getEntityClass() {
		return RiskAssessmentEntity.class;
	}
...
//		var includeMap = getIncludeMap(ResourceType.Bundle, keys, includes);
		...
		List<RiskAssessmentEntity> entitys = mongo.find(query, RiskAssessmentEntity.class);
		if (entitys != null && entitys.size() > 0) {
			for (RiskAssessmentEntity item : entitys) {
				RiskAssessment obj = transform(item);
	...
	public long countMatchesAdvancedTotal(
		...
		total = mongo.count(query, RiskAssessmentEntity.class);
		return total;
	}
