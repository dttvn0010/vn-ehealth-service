...
public class GoalProvider implements IResourceProvider {
    ...
    public MethodOutcome createGoal(HttpServletRequest theRequest, @ResourceParam Goal obj) {
        ...
        try {
            ...
            method.setOperationOutcome(OperationOutcomeFactory.createOperationOutcome("Create succsess",
                    "urn:uuid: " + mongoGoal.getId(), IssueSeverity.INFORMATION, IssueType.VALUE, myString));
    ...
    public MethodOutcome updateGoal(@IdParam IdType theId, @ResourceParam Goal patient) {
        ...
        method.setOperationOutcome(OperationOutcomeFactory.createOperationOutcome("Update succsess",
                "urn:uuid: " + newGoal.getId(), IssueSeverity.INFORMATION, IssueType.VALUE));
    ...
    public IBundleProvider searchGoal(HttpServletRequest request,
    	...
    	if (count != null && count > ConstantKeys.DEFAULT_PAGE_MAX_SIZE) {
            ...
            if (theSort != null) {
                ...
                results = goalDao.search(fhirContext, active, category, identifier, patient, startDate,
            ...
            return new IBundleProvider() {
                ...
                public Integer size() {
                	return Integer.parseInt(String.valueOf(
                			goalDao.countMatchesAdvancedTotal(fhirContext, active, category, identifier, patient, startDate,
                	                status, subject, targetDate, resid, _lastUpdated, _tag, _profile, _query, _security, _content)));                	        
                }
