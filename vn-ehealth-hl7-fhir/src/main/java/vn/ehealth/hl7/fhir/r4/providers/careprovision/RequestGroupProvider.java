...
@Component
public class RequestGroupProvider extends BaseController<RequestGroupEntity, RequestGroup>
		implements IResourceProvider {

	@Autowired
	RequestGroupDao baseDao;
	...
	@Override
	protected BaseDao<RequestGroupEntity, RequestGroup> getDao() {
		return baseDao;
	}
