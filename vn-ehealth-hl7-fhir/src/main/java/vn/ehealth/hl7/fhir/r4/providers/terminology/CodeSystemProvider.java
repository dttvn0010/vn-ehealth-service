...
public class CodeSystemProvider extends BaseController<CodeSystemEntity, CodeSystem> implements IResourceProvider {
	...
	public Parameters findMatchesAdvancedTotal(HttpServletRequest request,
			...
			@OperationParam(name = ConstantKeys.SP_CONTENT) TokenParam contentMode,
			...
			@OperationParam(name = ConstantKeys.SP_LANGUAGE) TokenParam language,
			...
			@OperationParam(name = ConstantKeys.SP_SYSTEM) UriParam system,
