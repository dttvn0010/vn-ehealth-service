...
public class ConditionProvider implements IResourceProvider {
    ...
    public MethodOutcome createCondition(HttpServletRequest theRequest, @ResourceParam Condition obj) {
        ...
        try {
            ...
            method.setOperationOutcome(OperationOutcomeFactory.createOperationOutcome("Create succsess",
                    "urn:uuid: " + mongoCondition.getId(), IssueSeverity.INFORMATION, IssueType.INCOMPLETE, myString));
    ...
    public MethodOutcome updateCondition(@IdParam IdType theId, @ResourceParam Condition patient) {
        ...
        method.setOperationOutcome(OperationOutcomeFactory.createOperationOutcome("Update succsess",
                "urn:uuid: " + newCondition.getId(), IssueSeverity.INFORMATION, IssueType.INCOMPLETE));
    ...
    @Search
    public List<Resource> searchCondition(HttpServletRequest request,
        ...
        if (count != null && count > 50) {
            ...
            if (theSort != null) {
                ...
                List<Resource> results = conditionDao.search(fhirContext, active, abatementAge, abatementBoolean,
