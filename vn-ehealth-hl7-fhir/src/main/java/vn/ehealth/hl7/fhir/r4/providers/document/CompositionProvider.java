...
@Component
public class CompositionProvider extends BaseController<CompositionEntity, Composition> implements IResourceProvider {

	@Autowired
	CompositionDao baseDao;
	...
	@Override
	protected BaseDao<CompositionEntity, Composition> getDao() {
		return baseDao;
	}
