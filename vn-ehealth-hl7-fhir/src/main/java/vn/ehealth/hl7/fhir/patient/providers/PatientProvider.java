...
public class PatientProvider implements IResourceProvider {
    ...
    public MethodOutcome createPatient(HttpServletRequest theRequest, @ResourceParam Patient patient) {
        ...
        try {
            ...
            Date cal2 = new Date();
            System.out.println("-------------------dao end------------------"+(cal2.getTime()-cal.getTime())+" ms");
        ...
        Date cal1 = new Date();
        System.out.println("-------------------create end------------------"+(cal1.getTime()-cal.getTime())+" ms");
        return method;
    }
    ...
    public Patient readVread(HttpServletRequest request, @IdParam IdType idType) {
        ...
        Date cal1 = new Date();
        System.out.println("-------------------readVread end------------------"+(cal1.getTime()-cal.getTime())+" ms");
        return object;
    }
    ...
    @Delete
    public Patient deletePatient(HttpServletRequest request, @IdParam IdType internalId) {
        Date cal = new Date();
        ...
        Date cal1 = new Date();
        System.out.println("-------------------delete end------------------"+(cal1.getTime()-cal.getTime())+" ms");
        return patient;
    }
    ...
    public MethodOutcome update(HttpServletRequest theRequest, @IdParam IdType theId, @ResourceParam Patient patient) {
        ...
        Date cal1 = new Date();
        System.out.println("-------------------update end------------------"+(cal1.getTime()-cal.getTime())+" ms");
        return method;
    }
    ...
    // Search result parameters
        ...
        long total = patientDao.findMatchesAdvancedTotal(fhirContext, active, addressUse, animalBreed, animalSpecies, deceased,
