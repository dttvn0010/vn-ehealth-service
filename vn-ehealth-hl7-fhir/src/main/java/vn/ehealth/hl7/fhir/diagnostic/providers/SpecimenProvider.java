...
public class SpecimenProvider implements IResourceProvider {
    ...
    public MethodOutcome createSpecimen(HttpServletRequest theRequest, @ResourceParam Specimen obj) {
        ...
        try {
            ...
            method.setOperationOutcome(OperationOutcomeFactory.createOperationOutcome("Create succsess",
                    "urn:uuid: " + mongoSpecimen.getId(), IssueSeverity.INFORMATION, IssueType.INCOMPLETE, myString));
    ...
    public MethodOutcome updateSpecimen(@IdParam IdType theId, @ResourceParam Specimen patient) {
        ...
        method.setOperationOutcome(OperationOutcomeFactory.createOperationOutcome("Update succsess",
                "urn:uuid: " + newSpecimen.getId(), IssueSeverity.INFORMATION, IssueType.INCOMPLETE));
    ...
    @Search
    public List<Resource> searchSpecimen(HttpServletRequest request,
        ...
        if (count != null && count > 50) {
            ...
            if (theSort != null) {
                ...
                List<Resource> results = specimenDao.search(fhirContext, active, resid, _lastUpdated, _tag, _profile,
