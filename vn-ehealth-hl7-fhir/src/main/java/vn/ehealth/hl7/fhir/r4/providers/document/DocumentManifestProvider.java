...
@Component
public class DocumentManifestProvider extends BaseController<DocumentManifestEntity, DocumentManifest>
		implements IResourceProvider {

	@Autowired
	DocumentManifestDao baseDao;
	...
	@Override
	protected BaseDao<DocumentManifestEntity, DocumentManifest> getDao() {
		return baseDao;
	}
