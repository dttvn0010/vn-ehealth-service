package vn.ehealth.hl7.fhir.r4.providers.product;
...
@Component
public class SubstanceProvider extends BaseController<SubstanceEntity, Substance> implements IResourceProvider {

	@Autowired
	SubstanceDao baseDao;
	...
	@Override
	protected BaseDao<SubstanceEntity, Substance> getDao() {
		return baseDao;
	}
