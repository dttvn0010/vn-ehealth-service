package vn.ehealth.hl7.fhir.interceptor;
...
public class ServerConsentInterceptor implements IConsentService {
	...
	public ConsentOutcome canSeeResource(RequestDetails theRequestDetails, IBaseResource theResource,
		...
		if (theResource instanceof Observation) {
			...
			if (obs.getCategoryFirstRep().hasCoding("http://hl7.org/fhir/codesystem-observation-category.html",
					"laboratory")) {
