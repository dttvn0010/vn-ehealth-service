package vn.ehealth.hl7.fhir.base.providers;
...
@Component
public class SubscriptionProvider extends BaseController<SubscriptionEntity, Subscription>
		implements IResourceProvider {

	@Autowired
	SubscriptionDao baseDao;
	...
	@Override
	protected BaseDao<SubscriptionEntity, Subscription> getDao() {
		return baseDao;
	}
