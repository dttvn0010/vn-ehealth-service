...
@Component
public class BodyStructureProvider extends BaseController<BodyStructureEntity, BodyStructure>
		implements IResourceProvider {

	@Autowired
	BodyStructureDao baseDao;
	...
	@Override
	protected BaseDao<BodyStructureEntity, BodyStructure> getDao() {
		return baseDao;
	}
