...
public class DeviceProvider implements IResourceProvider {
    ...
    public MethodOutcome createDevice(HttpServletRequest theRequest, @ResourceParam Device obj) {
        ...
        try {
            ...
            method.setOperationOutcome(OperationOutcomeFactory.createOperationOutcome("Create succsess",
                    "urn:uuid: " + mongoDevice.getId(), IssueSeverity.INFORMATION, IssueType.INCOMPLETE, myString));
    ...
    @Search
    public List<Resource> searchDevice(HttpServletRequest request,
        ...
        if (count != null && count > 50) {
            ...
            if (theSort != null) {
                ...
                List<Resource> results = deviceDao.search(fhirContext, deviceName, identifier, location, manufacturer, model,
            ...
            List<Resource> results = deviceDao.search(fhirContext, deviceName, identifier, location, manufacturer, model,
                    organization, patient, udiCarrier, udiDi, url, status, type, resid, _lastUpdated, _tag, _profile,
    ...
    public MethodOutcome updateDevice(@IdParam IdType theId, @ResourceParam Device patient) {
        ...
        method.setOperationOutcome(OperationOutcomeFactory.createOperationOutcome("Update succsess",
                "urn:uuid: " + newDevice.getId(), IssueSeverity.INFORMATION, IssueType.INCOMPLETE));
    ...
    public Parameters findMatchesAdvancedTotal(HttpServletRequest request,
        ...
        long total = deviceDao.findMatchesAdvancedTotal(fhirContext, deviceName, identifier, location, manufacturer, model,
                organization, patient, udiCarrier, udiDi, url, status, type, resid, _lastUpdated, _tag, _profile,
