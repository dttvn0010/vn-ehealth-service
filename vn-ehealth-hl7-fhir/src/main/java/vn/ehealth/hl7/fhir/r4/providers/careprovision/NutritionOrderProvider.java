package vn.ehealth.hl7.fhir.r4.providers.careprovision;
...
import vn.ehealth.hl7.fhir.careprovision.entity.NutritionOrderEntity;
...
@Component
public class NutritionOrderProvider extends BaseController<NutritionOrderEntity, NutritionOrder> implements IResourceProvider{

	@Autowired
	NutritionOrderDao baseDao;
	...
	@Override
	protected BaseDao<NutritionOrderEntity, NutritionOrder> getDao() {
		return baseDao;
	}
