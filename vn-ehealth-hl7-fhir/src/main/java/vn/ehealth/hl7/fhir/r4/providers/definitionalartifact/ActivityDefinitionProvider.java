package vn.ehealth.hl7.fhir.r4.providers.definitionalartifact;
...
@Component
public class ActivityDefinitionProvider extends BaseController<ActivityDefinitionEntity, ActivityDefinition>
		implements IResourceProvider {

	@Autowired
	ActivityDefinitionDao baseDao;
	...
	@Override
	protected BaseDao<ActivityDefinitionEntity, ActivityDefinition> getDao() {
		return baseDao;
	}
