...
public class ObservationProvider extends BaseController<ObservationEntity, Observation> implements IResourceProvider {
	...
	public Parameters getTotal(HttpServletRequest request,
			...
			@OperationParam(name = ConstantKeys.SP_CODE) TokenOrListParam code,
			@OperationParam(name = ConstantKeys.SP_COMBO_CODE) TokenParam comboCode,
			@OperationParam(name = ConstantKeys.SP_COMBO_DATA_ABSENT_REASON) TokenParam comboDataAbsentReason,
			@OperationParam(name = ConstantKeys.SP_COMBO_CODE_VALUE_CONCEPT) TokenParam comboValueConcept,
			@OperationParam(name = ConstantKeys.SP_COMPONENT_CODE) TokenParam componentCode,
			@OperationParam(name = ConstantKeys.SP_COMPONENT_DATA_ABSENT_REASON) TokenParam componentDataAbsentReason,
			@OperationParam(name = ConstantKeys.SP_COMPONENT_VALUE_CONCEPT) TokenParam componentValueConcept,
			@OperationParam(name = ConstantKeys.SP_CONTEXT) ReferenceParam conetext,
			@OperationParam(name = ConstantKeys.SP_DATA_ABSENT_REASON) TokenParam dataAbsentReason,
			...
			@OperationParam(name = ConstantKeys.SP_METHOD) TokenParam method,
			...
			@OperationParam(name = ConstantKeys.SP_RELATED_TARGET) ReferenceParam relatedTarget,
