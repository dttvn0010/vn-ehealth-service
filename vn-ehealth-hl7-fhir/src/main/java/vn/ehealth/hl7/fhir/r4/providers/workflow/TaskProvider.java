package vn.ehealth.hl7.fhir.r4.providers.workflow;
...
@Component
public class TaskProvider extends BaseController<TaskEntity, Task> implements IResourceProvider {
	...
	@Override
	protected BaseDao<TaskEntity, Task> getDao() {
		return baseDao;
	}
