...
public class PractitionerProvider implements IResourceProvider {
    ...
    @Search
    public List<Resource> searchPractitioner(HttpServletRequest request,
        ...
        if (count != null && count > 50) {
            ...
            if (theSort != null) {
                ...
                List<Resource> results = practitionerDao.search(fhirContext, active, address, addressCity, addressCountry,
            ...
            List<Resource> results = practitionerDao.search(fhirContext, active, address, addressCity, addressCountry,
                    addressPostalCode, addressState, addressUse, communication, email, family, gender, given,
                    identifier, name, phone, phonetic, telecom, resid, _lastUpdated, _tag, _profile, _query, _security,
                    _content, managingOrg, _page, "", count);
            return results;
        }
    }

    @Delete
    public Practitioner removePractitioner(HttpServletRequest request, @IdParam IdType internalId) {
    ...
    public Parameters findMatchesAdvancedTotal(HttpServletRequest request,
        ...
        long total = practitionerDao.countMatchesAdvancedTotal(fhirContext, active, address, addressCity, addressCountry,
