...
import vn.ehealth.hl7.fhir.security.entity.ConsentEntity;

@Component
public class ConsentProvider extends BaseController<ConsentEntity, Consent> implements IResourceProvider {
	...
	@Override
	protected BaseDao<ConsentEntity, Consent> getDao() {
		return baseDao;
	}
