...
public class CareTeamProvider implements IResourceProvider {
    ...
    public MethodOutcome createCareTeam(HttpServletRequest theRequest, @ResourceParam CareTeam obj) {
        ...
        try {
            ...
            method.setOperationOutcome(OperationOutcomeFactory.createOperationOutcome("Create succsess",
                    "urn:uuid: " + mongoCareTeam.getId(), IssueSeverity.INFORMATION, IssueType.INCOMPLETE, myString));
    ...
    @Search
    public List<Resource> searchCareTeam(HttpServletRequest request,
        ...
        if (count != null && count > 50) {
            ...
            if (theSort != null) {
                ...
                List<Resource> results = careTeamDao.search(fhirContext, active, category, context, date, encounter,
                        identifier, participant, patient, status, subject, resid, _lastUpdated, _tag, _profile, _query,
