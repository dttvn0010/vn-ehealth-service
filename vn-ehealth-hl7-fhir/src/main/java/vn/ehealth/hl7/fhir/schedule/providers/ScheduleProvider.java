...
public class ScheduleProvider implements IResourceProvider {
    ...
    @Create
    public MethodOutcome createDevice(HttpServletRequest theRequest, @ResourceParam Schedule obj) {
        ...
        try {
            ...
            method.setOperationOutcome(OperationOutcomeFactory.createOperationOutcome("Create succsess",
                    "urn:uuid: " + mongoSchedule.getId(), IssueSeverity.INFORMATION, IssueType.INCOMPLETE, myString));
    ...
    @Search
    public List<Resource> searchSchedule(HttpServletRequest request,
        ...
        if (count != null && count > 50) {
            ...
            if (theSort != null) {
                ...
                List<Resource> results = scheduleDao.search(fhirContext, active, identifier, actor, date, type, resid,
    ...
    @Update
    public MethodOutcome updateSchedule(@IdParam IdType theId, @ResourceParam Schedule patient) {
        ...
        method.setOperationOutcome(OperationOutcomeFactory.createOperationOutcome("Update succsess",
                "urn:uuid: " + newSchedule.getId(), IssueSeverity.INFORMATION, IssueType.INCOMPLETE));
