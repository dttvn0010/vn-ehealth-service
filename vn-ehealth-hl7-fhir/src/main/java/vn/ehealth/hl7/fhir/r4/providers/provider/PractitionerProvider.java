...
public class PractitionerProvider extends BaseController<PractitionerEntity, Practitioner>
	...
	public Parameters findMatchesAdvancedTotal(HttpServletRequest request,
			...
			@OperationParam(name = ConstantKeys.SP_ADDRESS_POSTALCODE) StringParam addressPostalCode,
			@OperationParam(name = ConstantKeys.SP_ADDRESSSTATE) StringParam addressState,
			@OperationParam(name = ConstantKeys.SP_ADDRESS_USE) TokenParam addressUse,
			@OperationParam(name = ConstantKeys.SP_COMMUNICATION) TokenParam communication,
			@OperationParam(name = ConstantKeys.SP_EMAIL) TokenParam email,
			@OperationParam(name = ConstantKeys.SP_FAMILY) StringParam family,
			@OperationParam(name = ConstantKeys.SP_GENDER) TokenParam gender,
			@OperationParam(name = ConstantKeys.SP_GIVEN) StringParam given,
			...
			@OperationParam(name = ConstantKeys.SP_TOKEN) TokenParam telecom,
			...
			@OperationParam(name = "managingOrg") ReferenceParam managingOrg) {
