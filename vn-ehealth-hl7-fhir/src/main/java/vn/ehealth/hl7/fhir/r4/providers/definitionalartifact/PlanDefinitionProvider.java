...
@Component
public class PlanDefinitionProvider extends BaseController<PlanDefinitionEntity, PlanDefinition>
		implements IResourceProvider {

	@Autowired
	PlanDefinitionDao baseDao;
	...
	@Override
	protected BaseDao<PlanDefinitionEntity, PlanDefinition> getDao() {
		return baseDao;
	}
