...
public class AppointmentProvider implements IResourceProvider {
	...
	public MethodOutcome createDevice(HttpServletRequest theRequest, @ResourceParam Appointment object) {
		...
		try {
			...
			method.setOperationOutcome(OperationOutcomeFactory.createOperationOutcome("Create succsess",
					"urn:uuid: " + mongoAppointment.getId(), IssueSeverity.INFORMATION, IssueType.VALUE, myString));
	...
	@Delete
	public Appointment delete(HttpServletRequest request, @IdParam IdType internalId) {
	...
	@Update
	public MethodOutcome update(@IdParam IdType theId, @ResourceParam Appointment obj) {
		...
		try {
			newAppointment = appointmentDao.update(fhirContext, obj, theId);
		} catch (Exception ex) {
			if (ex instanceof OperationOutcomeException) {
				OperationOutcomeException outcomeException = (OperationOutcomeException) ex;
				method.setOperationOutcome(outcomeException.getOutcome());
		...
		method.setOperationOutcome(OperationOutcomeFactory.createOperationOutcome("Update succsess",
				"urn:uuid: " + newAppointment.getId(), IssueSeverity.INFORMATION, IssueType.VALUE));
