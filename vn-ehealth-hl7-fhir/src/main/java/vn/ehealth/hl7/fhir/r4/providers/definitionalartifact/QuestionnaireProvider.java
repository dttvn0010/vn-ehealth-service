...
@Component
public class QuestionnaireProvider extends BaseController<QuestionnaireEntity, Questionnaire>
		implements IResourceProvider {

	@Autowired
	QuestionnaireDao baseDao;
	...
	@Override
	protected BaseDao<QuestionnaireEntity, Questionnaire> getDao() {
		return baseDao;
	}
