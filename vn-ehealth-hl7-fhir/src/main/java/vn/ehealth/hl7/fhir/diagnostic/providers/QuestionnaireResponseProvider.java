...
@Component
public class QuestionnaireResponseProvider extends BaseController<QuestionnaireResponseEntity, QuestionnaireResponse>
		implements IResourceProvider {

	@Autowired
	QuestionnaireResponseDao baseDao;
	...
	@Override
	protected BaseDao<QuestionnaireResponseEntity, QuestionnaireResponse> getDao() {
		return baseDao;
	}
