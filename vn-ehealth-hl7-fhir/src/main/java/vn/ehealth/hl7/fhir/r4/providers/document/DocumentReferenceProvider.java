package vn.ehealth.hl7.fhir.r4.providers.document;
...
import vn.ehealth.hl7.fhir.document.entity.DocumentReferenceEntity;
...
@Component
public class DocumentReferenceProvider extends BaseController<DocumentReferenceEntity, DocumentReference> implements IResourceProvider{

	@Autowired
	DocumentReferenceDao baseDao;
	...
	@Override
	protected BaseDao<DocumentReferenceEntity, DocumentReference> getDao() {
		return baseDao;
	}
