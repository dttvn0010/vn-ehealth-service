package vn.ehealth.hl7.fhir.r4.providers.security;
...
import vn.ehealth.hl7.fhir.security.entity.ProvenanceEntity;

@Component
public class ProvenanceProvider extends BaseController<ProvenanceEntity, Provenance> implements IResourceProvider {

	@Autowired
	ProvenanceDao baseDao;
	...
	@Override
	protected BaseDao<ProvenanceEntity, Provenance> getDao() {
		return baseDao;
	}
