...
public class ServiceRequestProvider  implements IResourceProvider {
    ...
    public MethodOutcome create(HttpServletRequest theRequest, @ResourceParam ServiceRequest obj) {
        ...
        try {
            ...
            method.setOperationOutcome(OperationOutcomeFactory.createOperationOutcome("Create succsess",
                    "urn:uuid: " + mongo.getId(), IssueSeverity.INFORMATION, IssueType.INFORMATIONAL, myString));
    ...
    @Search
    public List<Resource> search(HttpServletRequest request,
        ...
        if (count != null && count > 50) {
            ...
            if (theSort != null) {
                ...
                List<Resource> results = baseDao.search(fhirContext, active, bassedOn, category, code, context,
            ...
            List<Resource> results = baseDao.search(fhirContext, active, bassedOn, category, code, context, date,
    ...
    public MethodOutcome update(@IdParam IdType theId, @ResourceParam ServiceRequest input) {
        ...
        method.setOperationOutcome(OperationOutcomeFactory.createOperationOutcome("Update succsess",
                "urn:uuid: " + newObj.getId(), IssueSeverity.INFORMATION, IssueType.INFORMATIONAL));
    ...
    public Parameters getTotal(HttpServletRequest request,
        ...
        long total = baseDao.countMatchesAdvancedTotal(fhirContext, active, bassedOn, category, code, context,
