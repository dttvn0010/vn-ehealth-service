...
@Component
public class RiskAssessmentProvider extends BaseController<RiskAssessmentEntity, RiskAssessment>
		implements IResourceProvider {

	@Autowired
	RiskAssessmentDao baseDao;
	...
	@Override
	protected BaseDao<RiskAssessmentEntity, RiskAssessment> getDao() {
		return baseDao;
	}
