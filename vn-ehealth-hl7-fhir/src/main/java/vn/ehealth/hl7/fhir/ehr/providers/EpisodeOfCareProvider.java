...
public class EpisodeOfCareProvider implements IResourceProvider {
    ...
    public MethodOutcome createEpisodeOfCare(HttpServletRequest theRequest, @ResourceParam EpisodeOfCare obj) {
        ...
        try {
            ...
            method.setOperationOutcome(OperationOutcomeFactory.createOperationOutcome("Create succsess",
                    "urn:uuid: " + mongoEpisodeOfCare.getId(), IssueSeverity.INFORMATION, IssueType.INCOMPLETE,
                    myString));
    ...
    @Search
    public List<Resource> searchEpisodeOfCare(HttpServletRequest request,
        ...
        if (count != null && count > 50) {
            ...
            if (theSort != null) {
                ...
                List<Resource> results = episodeOfCareDao.search(fhirContext, active, careManager, condition, date, identifier,
    ...
    public MethodOutcome updateEpisodeOfCare(@IdParam IdType theId, @ResourceParam EpisodeOfCare patient) {
        ...
        method.setOperationOutcome(OperationOutcomeFactory.createOperationOutcome("Update succsess",
                "urn:uuid: " + newEpisodeOfCare.getId(), IssueSeverity.INFORMATION, IssueType.INCOMPLETE));
    ...
    public Parameters getTotal(HttpServletRequest request,
        ...
        long total = episodeOfCareDao.getTotal(fhirContext, active, careManager, condition, date, identifier, incomingreferral,
