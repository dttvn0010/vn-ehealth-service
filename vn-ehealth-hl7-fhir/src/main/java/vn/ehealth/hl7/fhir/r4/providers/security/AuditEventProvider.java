...
@Component
public class AuditEventProvider extends BaseController<AuditEventEntity, AuditEvent> implements IResourceProvider {

	@Autowired
	AuditEventDao baseDao;
	...
	@Override
	protected BaseDao<AuditEventEntity, AuditEvent> getDao() {
		return baseDao;
	}
