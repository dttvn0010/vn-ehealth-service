...
public class ProcedureProvider implements IResourceProvider {
    ...
    public MethodOutcome createProcedure(HttpServletRequest theRequest, @ResourceParam Procedure obj) {
        ...
        try {
            ...
            method.setOperationOutcome(OperationOutcomeFactory.createOperationOutcome("Create succsess",
                    "urn:uuid: " + mongoProcedure.getId(), IssueSeverity.INFORMATION, IssueType.INCOMPLETE, myString));
    ...
    @Search
    public List<Resource> searchProcedure(HttpServletRequest request,
        ...
        if (count != null && count > 50) {
            ...
            if (theSort != null) {
                ...
                List<Resource> results = procedureDao.search(fhirContext, active, bassedOn, category, code, context,
            ...
            List<Resource> results = procedureDao.search(fhirContext, active, bassedOn, category, code, context, date,
    ...
    public MethodOutcome updateProcedure(@IdParam IdType theId, @ResourceParam Procedure patient) {
        ...
        method.setOperationOutcome(OperationOutcomeFactory.createOperationOutcome("Update succsess",
                "urn:uuid: " + newProcedure.getId(), IssueSeverity.INFORMATION, IssueType.INCOMPLETE));
