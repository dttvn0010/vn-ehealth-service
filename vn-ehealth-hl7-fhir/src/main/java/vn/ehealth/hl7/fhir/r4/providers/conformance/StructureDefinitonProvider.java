package vn.ehealth.hl7.fhir.r4.providers.conformance;
...
import vn.ehealth.hl7.fhir.conformance.dao.impl.StructureDefinitionDao;
...
@Component
public class StructureDefinitonProvider extends BaseController<StructureDefinitionEntity, StructureDefinition>
		implements IResourceProvider {

	@Autowired
	StructureDefinitionDao baseDao;

	@Override
	protected BaseDao<StructureDefinitionEntity, StructureDefinition> getDao() {
		return baseDao;
	}
